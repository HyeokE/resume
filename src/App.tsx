  ...
  return (
    <div className="container">
          ...
          <div className={'row-right'}>
            ...
            <div className={'project'}>
              ...
              <p>
                ...
                기획하였습니다. 현재 진행 중인 프로젝트로 애자일 방법론을
                적용하여 일주일에 한번씩 스프린트를 진행하고 있습니다.
                재사용성과 최적화를 중점적으로 고려하여 개발 중입니다.
              </p>
              <h5>
                What did I do<span className="period-mark">.</span>
              </h5>
      ...
      <section>
        ...
        <ul>
          <li>Name: 정준혁 [Jeong Jun-Hyeok]</li>
